...
if __name__ == "__main__":
    ...
    print("Time taken: " + str(time.time() - start))
    import numpy as np
    np.save("LLM_Model_Conversion/Context_Data_Files/netlogo_dictionary_embeddings", customized_embeddings)
    with open("LLM_Model_Conversion/Context_Data_Files/netlogo_dictionary_plain_text.json", "w") as f:
