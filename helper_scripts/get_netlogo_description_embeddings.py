...
if __name__ == "__main__":
    json_files = [
	 "LLM_Model_Conversion/Context_Data_Files/netlogo_described.json",
]
    instruction_set = [
        ["Represent this short description of a cpp codeblock for retrieval:","Here is a description of a block of netlogo code"],
    ]
    ...
    print("Time taken: " + str(time.time() - start))
    import numpy as np
    np.save("LLM_Model_Conversion/Context_Data_Files/netlogo_long_description_embeddings", customized_embeddings)
    with open("LLM_Model_Conversion/Context_Data_Files/netlogo_description_text.json", "w") as f:
