...
g++ -std=c++11 -Iinclude ./src/*.cpp -Ofast -fPIC -Wall -Wpedantic -lSDL2 -o test.o  #version with rendering
# g++ -std=c++11 -Iinclude ./src/*.cpp -Ofast -fPIC -Wall -Wpedantic -o test.o    # no rendering with this version
