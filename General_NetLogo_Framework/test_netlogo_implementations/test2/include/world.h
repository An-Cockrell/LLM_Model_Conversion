...
public:
  ...
  // declare more implementation specific functions below. Turtle specific functions should take a pointer to a turtle as an argument

  std::shared_ptr<Turtle> create_deer_turtle(int x, int y, int id, int heading);
  std::shared_ptr<Turtle> create_wolf_turtle(int x, int y, int id, int heading);
