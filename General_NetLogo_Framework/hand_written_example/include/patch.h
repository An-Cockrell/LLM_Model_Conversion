...
public:
     ...
     */
    Patch(int xCoord, int yCoord) : Agent(xCoord, yCoord) { setColor("grey"); };
    ...
    // functions for rendering secondary colors/tracking cytokines for display
    ...
    double getModeOpacity(){return 0;}
