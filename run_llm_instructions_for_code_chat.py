...
if __name__=="__main__":
    ...
    header_filepath_prefix = "General_NetLogo_Framework/test_netlogo_implementations/test3/include/"
    ...
    with open("General_NetLogo_Framework/test_netlogo_implementations/test3/src/world_custom_implementations.cpp", "r") as f:
        simulation_framework_txt += f.read() + "\n\n\n"
    ...
    while user_prompt != "quit":
        ...
        if user_prompt == "generate":
            ...
            with torch.no_grad(), torch.backends.cuda.sdp_kernel(enable_flash=False, enable_math=False, enable_mem_efficient=True):
                ...
                prompt = ""
                with open("./LLM_output_files/iirabm_header_instructions3.json", "w") as f:
